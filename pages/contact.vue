...
<template>
    <div class="p-6">
        ...
        >
            <div
                v-if="showToast" 
                class="fixed top-4 right-4 z-50 bg-black text-white px-4 py-3 rounded-lg shadow-lg flex items-center space-x-2">
        ...
        <div class="flex flex-wrap justify-center gap-6">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0 relative">
                        ...
                        <div class="absolute -bottom-1 -right-1 flex items-center">
                            ...
                            <div
                                v-else
                                class="w-3 h-3 rounded-full border-2 border-white bg-gray-300 animate-pulse"
                            />
                        </div>
                    </div>
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <span
                                v-if="!isLoadingStatus"
                                :class="getDiscordStatusBadgeClasses(discordStatus)"
                            >
                        ...
                        <!-- Activity preview -->
                        <div v-if="getPrimaryActivityForDisplay() && !isLoadingStatus" class="mt-3 p-2 bg-gray-50 rounded border-l-2 border-black/20">
                ...
                <div
                    ...
                    <div class="space-y-2">
                        <div v-for="activity in discordActivities" :key="activity.id" class="border-b border-gray-100 last:border-b-0 pb-2 last:pb-0">
                    ...
                    <!-- Arrow pointing down -->
                    <div class="absolute top-full left-1/2 transform -translate-x-1/2 border-4 border-transparent border-t-gray-200"/>
                </div>
            </div>
